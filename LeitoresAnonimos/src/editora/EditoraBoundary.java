...
public class EditoraBoundary extends Application {
    ...
    public void start(Stage Stage) throws Exception {
        ...
        btnPesquisar.getStylesheets().add(EditoraBoundary.class.getResource("EditoraStyles.css").toExternalForm());
        lblCodigo.relocate(150, 70);
        txtCodigo.relocate(100, 90);

        lblNome.relocate(150, 120);
        txtNome.relocate(100, 140);
        btnAdd.relocate(150, 200);
        btnAlt.relocate(50,200);
        btnRmv.relocate(300, 200);
        btnCon.relocate(150, 200);
        btnCan.relocate(150, 200);

        btnAdd.getStylesheets().add(EditoraBoundary.class.getResource("EditoraStyles.css").toExternalForm());
        btnAlt.getStylesheets().add(EditoraBoundary.class.getResource("EditoraStyles.css").toExternalForm());
        btnCon.getStylesheets().add(EditoraBoundary.class.getResource("EditoraStyles.css").toExternalForm());
